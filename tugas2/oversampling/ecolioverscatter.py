...
x,y = Y_pd[0], Y_pd[1];
ax4.scatter(x, y, c=new_target2,marker='+');
ax4.set_title('SMOTETomeks data')
...
x,y = Y_pd[0], Y_pd[1];
ax5.scatter(x, y, c=new_target_ENN,marker='+');
ax5.set_title('SMOTEENN data')
